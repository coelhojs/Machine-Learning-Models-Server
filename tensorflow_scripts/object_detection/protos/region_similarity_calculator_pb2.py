...
# source: tensorflow_scripts/object_detection/protos/region_similarity_calculator.proto
...
RegionSimilarityCalculator = _reflection.GeneratedProtocolMessageType('RegionSimilarityCalculator', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.region_similarity_calculator_pb2'
