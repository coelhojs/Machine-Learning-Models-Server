...
# source: tensorflow_scripts/object_detection/protos/optimizer.proto
...
Optimizer = _reflection.GeneratedProtocolMessageType('Optimizer', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.optimizer_pb2'
