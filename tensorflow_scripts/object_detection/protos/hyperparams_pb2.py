...
# source: tensorflow_scripts/object_detection/protos/hyperparams.proto
...
Hyperparams = _reflection.GeneratedProtocolMessageType('Hyperparams', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.hyperparams_pb2'
