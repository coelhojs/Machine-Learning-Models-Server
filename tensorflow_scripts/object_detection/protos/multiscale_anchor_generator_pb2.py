...
# source: tensorflow_scripts/object_detection/protos/multiscale_anchor_generator.proto
...
MultiscaleAnchorGenerator = _reflection.GeneratedProtocolMessageType('MultiscaleAnchorGenerator', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.multiscale_anchor_generator_pb2'
