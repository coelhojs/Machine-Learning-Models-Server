...
# source: tensorflow_scripts/object_detection/protos/input_reader.proto
...
InputReader = _reflection.GeneratedProtocolMessageType('InputReader', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.input_reader_pb2'
