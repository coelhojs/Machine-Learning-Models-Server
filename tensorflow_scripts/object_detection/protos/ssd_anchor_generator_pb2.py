...
# source: tensorflow_scripts/object_detection/protos/ssd_anchor_generator.proto
...
SsdAnchorGenerator = _reflection.GeneratedProtocolMessageType('SsdAnchorGenerator', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.ssd_anchor_generator_pb2'
