...
# source: tensorflow_scripts/object_detection/protos/faster_rcnn_box_coder.proto
...
FasterRcnnBoxCoder = _reflection.GeneratedProtocolMessageType('FasterRcnnBoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.faster_rcnn_box_coder_pb2'
