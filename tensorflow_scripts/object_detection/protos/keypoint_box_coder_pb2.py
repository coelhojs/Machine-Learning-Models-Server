...
# source: tensorflow_scripts/object_detection/protos/keypoint_box_coder.proto
...
KeypointBoxCoder = _reflection.GeneratedProtocolMessageType('KeypointBoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.keypoint_box_coder_pb2'
