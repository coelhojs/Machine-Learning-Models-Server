...
# source: tensorflow_scripts/object_detection/protos/image_resizer.proto
...
ImageResizer = _reflection.GeneratedProtocolMessageType('ImageResizer', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.image_resizer_pb2'
