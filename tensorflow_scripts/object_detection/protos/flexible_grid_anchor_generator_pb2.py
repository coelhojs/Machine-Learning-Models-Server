...
# source: tensorflow_scripts/object_detection/protos/flexible_grid_anchor_generator.proto
...
FlexibleGridAnchorGenerator = _reflection.GeneratedProtocolMessageType('FlexibleGridAnchorGenerator', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.flexible_grid_anchor_generator_pb2'
