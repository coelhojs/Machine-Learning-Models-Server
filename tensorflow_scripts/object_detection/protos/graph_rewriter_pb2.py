...
# source: tensorflow_scripts/object_detection/protos/graph_rewriter.proto
...
GraphRewriter = _reflection.GeneratedProtocolMessageType('GraphRewriter', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.graph_rewriter_pb2'
