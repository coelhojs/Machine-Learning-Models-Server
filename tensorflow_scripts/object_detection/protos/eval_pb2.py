...
# source: tensorflow_scripts/object_detection/protos/eval.proto
...
EvalConfig = _reflection.GeneratedProtocolMessageType('EvalConfig', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.eval_pb2'
