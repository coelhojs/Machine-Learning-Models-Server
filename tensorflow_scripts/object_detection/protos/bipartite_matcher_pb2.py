...
# source: tensorflow_scripts/object_detection/protos/bipartite_matcher.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorflow_scripts/object_detection/protos/bipartite_matcher.proto',
  package='object_detection.protos',
  syntax='proto2',
  serialized_options=None,
  serialized_pb=_b('\nBtensorflow_scripts/object_detection/protos/bipartite_matcher.proto\x12\x17object_detection.protos\"4\n\x10\x42ipartiteMatcher\x12 \n\x11use_matmul_gather\x18\x06 \x01(\x08:\x05\x66\x61lse')
)
...
BipartiteMatcher = _reflection.GeneratedProtocolMessageType('BipartiteMatcher', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.bipartite_matcher_pb2'
