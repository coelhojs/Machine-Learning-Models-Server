...
# source: tensorflow_scripts/object_detection/protos/argmax_matcher.proto
...
ArgMaxMatcher = _reflection.GeneratedProtocolMessageType('ArgMaxMatcher', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_scripts.object_detection.protos.argmax_matcher_pb2'
