...
# source: tensorflow_serving/gRPC_apis/predict.proto
...
from tensorflow_scripts.gRPC_apis import model_pb2 as tensorflow__serving_dot_apis_dot_model__pb2
...
PredictRequest = _reflection.GeneratedProtocolMessageType('PredictRequest', (_message.Message,), dict(
  ...
  InputsEntry = _reflection.GeneratedProtocolMessageType('InputsEntry', (_message.Message,), dict(
    ...
    __module__ = 'tensorflow_serving.gRPC_apis.predict_pb2'
