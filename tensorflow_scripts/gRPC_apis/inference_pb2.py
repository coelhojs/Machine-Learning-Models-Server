...
# source: tensorflow_serving/gRPC_apis/inference.proto
...
InferenceTask = _reflection.GeneratedProtocolMessageType('InferenceTask', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_serving.gRPC_apis.inference_pb2'
