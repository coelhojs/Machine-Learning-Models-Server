...
# source: tensorflow_serving/gRPC_apis/classification.proto
...
Class = _reflection.GeneratedProtocolMessageType('Class', (_message.Message,), dict(
  DESCRIPTOR = _CLASS,
  __module__ = 'tensorflow_serving.gRPC_apis.classification_pb2'
