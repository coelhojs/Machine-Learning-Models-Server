...
# source: tensorflow_serving/gRPC_apis/regression.proto
...
Regression = _reflection.GeneratedProtocolMessageType('Regression', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow_serving.gRPC_apis.regression_pb2'
